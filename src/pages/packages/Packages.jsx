    ...
    <>
      <div className="overflow-auto no-scrollbar">
        ...
        <div className="grid grid-cols-12 gap-2">
          <div className="md:col-span-3 col-span-12 sm:col-span-6 p-4 py-6 rounded-lg border-2  shadow-lg  font-Source_Sans_Pro bg-white">
            <div className=" flex justify-between py-2">
              <p className="bg-red-200 text-center text-red-700 w-20 rounded-lg p-1 text-base font-semibold">
                Inactive
              </p>
              <p
